 ...
 */
#define MY_DEFAULT_HOST_NAME			"PIC32TESTS"
 ...
 */
	...
	#define TCP_SPI_RAM_SIZE					(23005ul)
	...
	#define END_OF_TCP_SOCKET_TYPES
		...
		{
			{TCP_PURPOSE_GENERIC_TCP_CLIENT, TCP_SPI_RAM, 125, 1500},
			{TCP_PURPOSE_GENERIC_TCP_SERVER, TCP_SPI_RAM, 20, 1500},
			{TCP_PURPOSE_TELNET, TCP_SPI_RAM, 512, 1500},
			{TCP_PURPOSE_TELNET, TCP_SPI_RAM, 512, 1500},
			//{TCP_PURPOSE_TELNET, TCP_SPI_RAM, 512, 1500},
			//{TCP_PURPOSE_FTP_COMMAND, TCP_ETH_RAM, 100, 40},
			//{TCP_PURPOSE_FTP_DATA, TCP_ETH_RAM, 0, 128},
			{TCP_PURPOSE_TCP_PERFORMANCE_TX, TCP_SPI_RAM, 200, 1500},
			//{TCP_PURPOSE_TCP_PERFORMANCE_RX, TCP_SPI_RAM, 40, 1500},
			{TCP_PURPOSE_UART_2_TCP_BRIDGE, TCP_SPI_RAM, 512, 1500},
			{TCP_PURPOSE_HTTP_SERVER, TCP_SPI_RAM, 200, 1500},
			{TCP_PURPOSE_HTTP_SERVER, TCP_SPI_RAM, 200, 1500},
			{TCP_PURPOSE_DEFAULT, TCP_SPI_RAM, 200, 1500},
			{TCP_PURPOSE_BERKELEY_SERVER, TCP_SPI_RAM, 25, 1500},
			//{TCP_PURPOSE_BERKELEY_SERVER, TCP_SPI_RAM, 25, 1500},
			//{TCP_PURPOSE_BERKELEY_SERVER, TCP_SPI_RAM, 25, 1500},
			//{TCP_PURPOSE_BERKELEY_SERVER, TCP_SPI_RAM, 25, 1500},
			{TCP_PURPOSE_BERKELEY_CLIENT, TCP_SPI_RAM, 125, 1500},
			{TCP_PURPOSE_BERKELEY_CLIENT, TCP_SPI_RAM, 125, 1500},
			{TCP_PURPOSE_BERKELEY_CLIENT, TCP_SPI_RAM, 125, 1500},
			//{TCP_PURPOSE_BERKELEY_CLIENT, TCP_SPI_RAM, 125, 1500},
			//{TCP_PURPOSE_BERKELEY_CLIENT, TCP_SPI_RAM, 125, 1500},
