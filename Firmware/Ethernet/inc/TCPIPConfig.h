 ...
 */
	...
	#define TCP_PIC_RAM_SIZE					(6692ul)
	...
	#define END_OF_TCP_SOCKET_TYPES
		...
		{
			//{TCP_PURPOSE_GENERIC_TCP_CLIENT, TCP_PIC_RAM, 125, 1500},
			//{TCP_PURPOSE_GENERIC_TCP_SERVER, TCP_PIC_RAM, 20, 1500},
			//{TCP_PURPOSE_TELNET, TCP_PIC_RAM, 512, 1500},
			//{TCP_PURPOSE_TELNET, TCP_PIC_RAM, 512, 1500},
			//{TCP_PURPOSE_TELNET, TCP_PIC_RAM, 512, 1500},
			...
			//{TCP_PURPOSE_HTTP_SERVER, TCP_PIC_RAM, 200, 1500},
			//{TCP_PURPOSE_HTTP_SERVER, TCP_PIC_RAM, 200, 1500},
			//{TCP_PURPOSE_DEFAULT, TCP_SPI_RAM, 200, 1500},
			//{TCP_PURPOSE_BERKELEY_SERVER, TCP_PIC_RAM, 25, 1500},
			//{TCP_PURPOSE_BERKELEY_SERVER, TCP_PIC_RAM, 25, 1500},
			//{TCP_PURPOSE_BERKELEY_SERVER, TCP_PIC_RAM, 25, 1500},
			//{TCP_PURPOSE_BERKELEY_SERVER, TCP_PIC_RAM, 25, 1500},
			{TCP_PURPOSE_BERKELEY_CLIENT, TCP_PIC_RAM, 125, 1500},
			{TCP_PURPOSE_BERKELEY_CLIENT, TCP_PIC_RAM, 125, 1500},
			{TCP_PURPOSE_BERKELEY_CLIENT, TCP_PIC_RAM, 125, 1500},
			{TCP_PURPOSE_BERKELEY_CLIENT, TCP_PIC_RAM, 125, 1500},
			//{TCP_PURPOSE_BERKELEY_CLIENT, TCP_PIC_RAM, 125, 1500},
