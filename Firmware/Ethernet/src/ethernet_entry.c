...
int ethernetMain(void)
{
    ...
    while (1) {
        ...
        if (dwLastIP != AppConfig.MyIPAddr.Val) {
            ...
            getLCDData()->address = AppConfig.MyIPAddr;
            LCDPrintEthernet();
...
static void InitializeBoard(void) {
...
#if defined(__PIC32MX__)
    {
        ...
        CNPUASET = 0x00000001; // Turn on weak pull ups on CN15, CN16, CN19 (RD5, RD7, RD13), which is connected to buttons on PIC32 Starter Kit boards
    }
#endif
