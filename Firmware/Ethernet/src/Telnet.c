...
static ROM BYTE strTitle[] = "\x1b[2J\x1b[31m\x1b[1m" // 2J is clear screen, 31m is red, 1m is bold
        ...
        "(for this demo, type 'admin' for the login and 'password' for the password.)\r\n"
        "Login: ";
// Demo password
    ...
    for (vTelnetSession = 0; vTelnetSession < MAX_TELNET_CONNECTIONS; vTelnetSession++) {
        ...
        switch (TelnetState) {
            ...
            case SM_GET_PASSWORD_BAD_LOGIN:
                ...
                if ((w2 != 3u) || !((sizeof (TELNET_PASSWORD) - 1 == w - 4) || (sizeof (TELNET_PASSWORD) == w - 4)) || (TelnetState == SM_GET_PASSWORD_BAD_LOGIN)) {
